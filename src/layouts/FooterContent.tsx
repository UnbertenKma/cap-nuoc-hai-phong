  ...
  return (
    <div className="bg-white">
      <Row className="flex justify-between align-middle">
        <Col>
          <div className="mb-[36px] text-[#154398] text-base font-bold">
        ...
        <Col>
          ...
          <Row className="text-zinc-500 mb-[10px] text-base">
      ...
      <Divider />
      <Row gutter={10}>
        <div className="m-auto text-sm text-zinc-500 font-semibold">
